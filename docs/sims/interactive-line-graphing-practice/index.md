...
Practice graphing linear equations using all three methods (intercepts, slope-intercept, table of values). Use the selection menu and two parameter sliders to compare examples. Select **Check / Explain** for immediate conceptual feedback and **New Example** to continue exploring.
...
```html
<iframe src="https://dmccreary.github.io/algebra-1/sims/interactive-line-graphing-practice/main.html"
...
Practice graphing linear equations using all three methods (intercepts, slope-intercept, table of values).
