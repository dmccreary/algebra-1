...
Help students identify and understand the different parts of an algebraic expression interactively. Use the selection menu and two parameter sliders to compare examples. Select **Check / Explain** for immediate conceptual feedback and **New Example** to continue exploring.
...
```html
<iframe src="https://dmccreary.github.io/algebra-1/sims/expression-explorer-microsim/main.html"
...
Help students identify and understand the different parts of an algebraic expression interactively.
