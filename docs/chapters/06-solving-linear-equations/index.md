...
7. Equations with Decimals
8. Literal Equations
9. Solving for a Variable
10. Formula Manipulation
11. Linear Equation in One Variable
12. Solution Set
13. Identity Equation
14. Contradiction
15. Conditional Equation
...
- The variable appears only to the first power (no $x^2$, $x^3$, $\sqrt{x}$, etc.)
- The variable is not in a denominator
- The variable is not inside absolute value bars, under a radical, or in an exponent
...
2. Use addition/subtraction to collect variable terms on one side
3. Use addition/subtraction to collect constant terms on the other side
...
2. Move variable terms to one side (usually the side with the larger coefficient)
...
- Confirms you haven't made a sign error
- Verifies that you correctly applied the distributive property
- Ensures you didn't make a mistake when clearing fractions or decimals
...
2. Define variables
3. Write an equation based on the relationship described
