...
| 5 | Chapter Quizzes | 13 / 13 | Recommended | Chapters with a quiz.md (135 questions total) |
| 6 | Chapter References | 0 / 13 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 197 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 82 | Recommended | Questions in faq.md |
| 9 | Words | 93,156 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 36 | 36 | H4 headers starting with '#### Diagram:' |
| Equations | 3645 | 3034 | LaTeX expressions (inline and display) |
| Total Words | 93,156 | 65,745 | Words in markdown files |
| Links | 290 | 194 | Hyperlinks in markdown format |
| Equivalent Pages | 388 | 278 | Estimated pages (250 words/page + visuals) |
